...
#define COCOAPODS_POD_AVAILABLE_MUKUserNotificationViewController
#define COCOAPODS_VERSION_MAJOR_MUKUserNotificationViewController 0
#define COCOAPODS_VERSION_MINOR_MUKUserNotificationViewController 1
#define COCOAPODS_VERSION_PATCH_MUKUserNotificationViewController 0
